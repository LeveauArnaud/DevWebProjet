 ...
 */
final class Version20200520141349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande_verre (id INT AUTO_INCREMENT NOT NULL, id_client_id INT NOT NULL, id_verre_id INT NOT NULL, etat_id INT NOT NULL, date DATE NOT NULL, diam_d INT DEFAULT NULL, diam_g INT DEFAULT NULL, supp1 VARCHAR(255) DEFAULT NULL, supp2 VARCHAR(255) DEFAULT NULL, supp3 VARCHAR(255) DEFAULT NULL, supp4 VARCHAR(255) DEFAULT NULL, prix_od INT NOT NULL, prix_og INT NOT NULL, prix_supp1 INT DEFAULT NULL, prix_supp2 INT DEFAULT NULL, prix_supp3 INT DEFAULT NULL, prix_supp4 INT DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_F284081D99DED506 (id_client_id), INDEX IDX_F284081DD648CCDF (id_verre_id), INDEX IDX_F284081DD5E86FF (etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, rue VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, pays VARCHAR(100) NOT NULL, phone INT DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, sexe VARCHAR(1) NOT NULL, photo VARCHAR(255) DEFAULT NULL, code_postale INT NOT NULL, n_cli INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE correction (id INT AUTO_INCREMENT NOT NULL, id_prescripteur_id INT NOT NULL, id_client_id INT NOT NULL, date DATE NOT NULL, date_prescription DATE NOT NULL, commentaire LONGTEXT DEFAULT NULL, sph_od_l DOUBLE PRECISION DEFAULT NULL, cyl_od_l INT DEFAULT NULL, ax_od_l INT DEFAULT NULL, pd_od_l INT DEFAULT NULL, add_od INT DEFAULT NULL, add_lod INT DEFAULT NULL, sph_od_p INT DEFAULT NULL, cyl_od_p INT DEFAULT NULL, ax_od_p INT DEFAULT NULL, pd_od_p INT DEFAULT NULL, sph_og_l INT DEFAULT NULL, cyl_og_l INT DEFAULT NULL, ax_og_l INT DEFAULT NULL, pd_og_l INT DEFAULT NULL, add_og INT DEFAULT NULL, add_log INT DEFAULT NULL, sph_og_p INT DEFAULT NULL, cyl_og_p INT DEFAULT NULL, ax_og_p INT DEFAULT NULL, pd_og_p INT DEFAULT NULL, INDEX IDX_A29DA1B83DD825CA (id_prescripteur_id), INDEX IDX_A29DA1B899DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
