...
return [
    ...
    'api_get_client_id_correction' => [['id'], ['_controller' => 'App\\Controller\\APIController::correctionByClientID'], [], [['text', '/corrections'], ['variable', '/', '[^/]++', 'id'], ['text', '/api/client']], [], []],
    'api_get_client_id_verres' => [['id'], ['_controller' => 'App\\Controller\\APIController::verresByClientID'], [], [['text', '/verres'], ['variable', '/', '[^/]++', 'id'], ['text', '/api/client']], [], []],
    'api_update_verres' => [['cId', 'vId'], ['_controller' => 'App\\Controller\\APIController::updateVerresClient'], [], [['variable', '/', '[^/]++', 'vId'], ['text', '/verres'], ['variable', '/', '[^/]++', 'cId'], ['text', '/api/client']], [], []],
    'api_get_client_id_montures' => [['id'], ['_controller' => 'App\\Controller\\APIController::monturesByClientID'], [], [['text', '/montures'], ['variable', '/', '[^/]++', 'id'], ['text', '/api/client']], [], []],
    'api_get_stock' => [[], ['_controller' => 'App\\Controller\\APIController::findStock'], [], [['text', '/api/stocks']], [], []],
    'api_get_stock_monture' => [['id'], ['_controller' => 'App\\Controller\\APIController::findMontureInStock'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/api/stock']], [], []],
    'api_update_stock' => [['id'], ['_controller' => 'App\\Controller\\APIController::updateStock'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/api/stock']], [], []],
