...
return [
    ...
    'api_get_stock' => [['id'], ['_controller' => 'App\\Controller\\APIController::findMontureInStock'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/api/stock']], [], []],
    'api_update_stock' => [[], ['_controller' => 'App\\Controller\\APIController::new'], [], [['text', '/api/stock']], [], []],
