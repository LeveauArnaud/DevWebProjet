...
return [
    ...
    'api_liste' => [[], ['_controller' => 'App\\Controller\\APIController::liste'], [], [['text', '/api/client/liste']], [], []],
    'api_article' => [['id'], ['_controller' => 'App\\Controller\\APIController::getArticle'], [], [['variable', '=', '[^/]++', 'id'], ['text', '/api/client?id']], [], []],
    'api_product_show' => [['id'], ['_controller' => 'App\\Controller\\APIController::show'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/api/product']], [], []],
